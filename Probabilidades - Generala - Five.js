...
console.log("Generala (Five-of-a-kind): " + (generalas / simulaciones * 100));
console.log("Poker (Four-of-a-Kind): " + poker / simulaciones * 100);

console.log("Generala (Five-of-a-kind):  1 in " + simulaciones/generalas);
console.log("Poker (Four-of-a-Kind):  1 in " + simulaciones/poker);
